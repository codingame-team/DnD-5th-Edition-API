...
class Ui_boltacFrame(object):
    def setupUi(self, boltacFrame):
        ...
        self.gridLayout.addWidget(self.poolGoldButton, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.divvyGoldButton, 2, 1, 1, 1)
        self.character_label = QtWidgets.QLabel(boltacFrame)
        self.character_label.setObjectName("character_label")
        self.gridLayout.addWidget(self.character_label, 2, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.leaveBoltacButton, 3, 0, 1, 2)
    ...
    def retranslateUi(self, boltacFrame):
        ...
        self.leaveBoltacButton.setText(_translate("boltacFrame", "Return to Castle"))
